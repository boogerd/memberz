...
class MembershipTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership_type" do
    assert_difference("MembershipType.count") do
      post membership_types_url, params: { membership_type: { code: @membership_type.code, description: @membership_type.description, organisation_id: @membership_type.organisation_id, price: @membership_type.price } }
    end
  ...
  test "should update membership_type" do
    patch membership_type_url(@membership_type), params: { membership_type: { code: @membership_type.code, description: @membership_type.description, organisation_id: @membership_type.organisation_id, price: @membership_type.price } }
