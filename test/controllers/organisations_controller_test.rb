...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference("Organisation.count") do
      post organisations_url, params: { organisation: { coc_number: @organisation.coc_number, name: @organisation.name, vat_number: @organisation.vat_number } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { coc_number: @organisation.coc_number, name: @organisation.name, vat_number: @organisation.vat_number } }
